...
- The sign-in panel places Forgot password below Remember me and Create account beneath Sign in; the reset view centers its Back to sign in action. Reset links are one-time, expire after 30 minutes, and are delivered through the configured SMTP provider without exposing whether an email address belongs to an account.
